<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SelectCityForView.aspx.cs" Inherits="MyProject.SelectCityForView" MasterPageFile="~/Site.Master" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <section class="bg-gradient-to-r from-primary to-secondary text-white py-2">
        <div class="max-w-4xl mx-auto px-2 sm:px-4 lg:px-6 text-center">
            ...
            <p class="text-lg md:text-xl opacity-90">ပရဟိတလုပ်ငန်းများ၏ Post များကြည့်ရန်မြို့တစ်မြို့ကိုရွေးချယ်ပါ</p>
        </div>
    </section>
    ...
    <script>
        function selectCity(cityId) {
            ...
            setTimeout(function () {
                window.location.href = 'ViewPosts.aspx?city=' + cityId;
            }, 500);
        }
    </script>
